...
<div class="bg-primary-dark" style="background-image: url({{asset('images/general/banner6.png')}}); background-size: cover  ; background-repeat: no-repeat ">
    <div class="content content-full text-center">
      ...
      <h1 class="h2 text-white mb-0">Add Subjects</h1>
...
<div class="content content-boxed">
  ...
  <div class="block block-rounded">
    <div class="block-header block-header-default">
      <h3 class="block-title">New Subjects</h3>
    </div>
    <div class="block-content">
          ...
          <div class="col-12">
              ...
              {!! Form::open(['method'=>'POST', 'action'=>'App\Http\Controllers\AdminSubjectController@store','files'=>true]) !!}
