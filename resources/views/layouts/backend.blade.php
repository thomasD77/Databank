...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title>{{ Auth::user()->billing ? Auth::user()->billing->company : "DataBank" }}</title>
        ...
        <!-- Icons -->
        <link rel="shortcut icon" href="{{ asset('images/docs/database.png') }}">
        <link rel="icon" sizes="192x192" type="image/png" href="{{ asset('images/docs/database.png') }}">
        <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('images/docs/database.png') }}">
